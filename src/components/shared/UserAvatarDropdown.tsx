    ...
    return (
        <>
            <DropdownMenu>
                ...
                <DropdownMenuContent align="end" className="w-60 rounded-2xl font-sans mt-2 shadow-[0_10px_40px_-10px_rgba(0,0,0,0.1)] border-slate-100 z-50">
                    <div dir="rtl">
             ...
             <Dialog open={isPhotoDialogOpen} onOpenChange={setIsPhotoDialogOpen}>
                <DialogContent className="font-sans sm:max-w-[400px] rounded-[2rem] gap-0 p-0 overflow-hidden shadow-2xl border-0">
                    <div dir="rtl">
