    ...
    return (
        <div className="min-h-screen bg-[#050505] flex flex-col p-6 md:p-12 relative overflow-hidden font-sans text-white">
            ...
            <div className="absolute inset-0 pointer-events-none z-0">
                ...
                <div className="absolute bottom-1/4 left-1/4 w-96 h-96 bg-orange-400/5 rounded-full blur-[100px]" />
            </div>
                ...
                >
                    ...
                    {!isAdmin && (
                        <div className="space-y-3 mb-6">
                            ...
                            <div className="relative flex items-center py-2">
                                ...
                                <span className="flex-shrink-0 mx-4 text-slate-500 text-xs">أو بالبريد الإلكتروني</span>
                                <div className="flex-grow border-t border-white/10"></div>
                            </div>
                        </div>
                    )}
                    ...
                    <form onSubmit={handleLogin} className="space-y-4">
                        <div className="space-y-1.5">
                            <label className="text-sm font-semibold text-slate-300 mr-1" htmlFor="email">
                        ...
                        {!(!isAdmin && email === '') && (
                            <motion.div initial={{ height: 0, opacity: 0 }} animate={{ height: 'auto', opacity: 1 }} className="space-y-1.5">
                                <label className="text-sm font-semibold text-slate-300 mr-1" htmlFor="password">
