                                        ...
                                        perspective: '800px',
                                            ...
                                            y: { duration: 3, repeat: Infinity, ease: 'easeInOut' },
                                                    ...
                                                    boxShadow: `0 20px 60px ${charMeta.glow}, 0 0 120px ${charMeta.glow}, inset 0 1px 0 rgba(255,255,255,0.1)`,
                                                            ...
                                                            repeat: Infinity,
                                                            ease: 'easeInOut',
                                                        }, className: "text-7xl md:text-8xl select-none", style: {
                                                            filter: `drop-shadow(0 8px 20px ${charMeta.glow})`,
                                                            transform: 'translateZ(30px)',
                                                        }, children: charMeta.emoji }), _jsx(motion.div, { animate: {
                                                            scale: [1, 1.2, 1],
                                                            opacity: [0.3, 0.6, 0.3],
                                                    ...
                                                    }, animate: { scale: isPaused ? [1, 1.2, 1] : 1 }, transition: { duration: 1.5, repeat: isPaused ? Infinity : 0, ease: 'easeInOut' } })] })] }), _jsxs("div", { className: "flex items-center gap-4 mt-10", children: [_jsx(motion.button, { whileHover: { scale: 1.05 }, whileTap: { scale: 0.95 }, onClick: handleReset, className: "w-14 h-14 rounded-2xl bg-white/5 border border-white/10 flex items-center justify-center text-white/50 hover:text-white hover:bg-white/10 transition-all", children: _jsx(RotateCcw, { className: "w-5 h-5" }) }), _jsx(motion.button, { whileHover: { scale: 1.05 }, whileTap: { scale: 0.95 }, onClick: () => setIsPaused(!isPaused), className: "h-14 px-10 rounded-2xl font-bold text-base flex items-center gap-3 transition-all", style: {
