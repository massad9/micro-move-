                ...
                >
                    <div className="mb-4 relative group">
                        <Avatar className="w-20 h-20 sm:w-24 sm:h-24 border-4 border-slate-300 shadow-xl group-hover:scale-105 transition-transform">
                            <AvatarImage src={`https://i.pravatar.cc/150?u=${top3[1]?.name}`} />
                ...
                >
                    <div className="mb-6 relative group">
                        ...
                        <Avatar className="w-28 h-28 sm:w-32 sm:h-32 border-4 border-amber-400 shadow-[0_0_30px_rgba(251,191,36,0.4)] group-hover:scale-110 transition-transform relative z-10">
                            <AvatarImage src={`https://i.pravatar.cc/150?u=${top3[0]?.name}`} />
                ...
                >
                    <div className="mb-4 relative group">
                        <Avatar className="w-20 h-20 sm:w-24 sm:h-24 border-4 border-orange-300 shadow-xl group-hover:scale-105 transition-transform">
                            <AvatarImage src={`https://i.pravatar.cc/150?u=${top3[2]?.name}`} />
                ...
                <Card className="bg-white border text-right border-slate-200 shadow-md rounded-[2rem] overflow-hidden">
                    <CardContent className="p-0">
                        <div className="divide-y divide-slate-100">
                            ...
                            <div className="p-4 sm:p-6 flex items-center justify-between hover:bg-slate-50/80 transition-colors group relative bg-orange-50/30">
                                ...
                                <div className="flex-1 flex items-center gap-4">
                                    <Avatar className="w-12 h-12 border-2 border-white shadow-sm">
                                        ...
                                        <AvatarFallback className="bg-primary text-white font-bold">أ</AvatarFallback>
                                    </Avatar>
                                    <div>
                                ...
                                <div className="w-24 text-left">
                                    <div className="bg-white px-3 py-1.5 rounded-lg border border-slate-200 inline-block text-left shadow-sm">
                            ...
                            {[4, 5].map((rank) => (
                                <div key={rank} className="p-4 sm:p-6 flex items-center justify-between hover:bg-slate-50 transition-colors group">
                                    <div className="w-16 text-center font-bold text-slate-400 text-lg">{rank}</div>
                                    <div className="flex-1 flex items-center gap-4">
                                        <Avatar className="w-12 h-12 border-2 border-slate-100">
                                            <AvatarFallback className="bg-slate-100 text-slate-500 font-bold text-lg">م</AvatarFallback>
                                        </Avatar>
                                        <div>
                                            <h4 className="font-bold text-slate-900 text-base sm:text-lg">زميل مبدع {rank}</h4>
                                            <p className="text-sm font-semibold text-slate-500">التسويق</p>
                                        </div>
                                    </div>
                                    <div className="w-24 text-left">
                                        <div className="bg-slate-50 px-3 py-1.5 rounded-lg border border-slate-100 inline-block text-left group-hover:bg-white group-hover:border-slate-200 transition-colors">
                                            <span className="font-black text-slate-700 text-base sm:text-lg">{Math.floor(2000 / rank)}</span>
                                        </div>
                                    </div>
                                </div>
                            ))}
